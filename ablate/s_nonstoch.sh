...
python train_3d.py --dataset ./data/natlantic/$Split --checkpoint_dir . --name $ModelName --eval_batch_size 32 --start_idx $StartSample --end_idx $EndSample --no_sample_clip
ls
